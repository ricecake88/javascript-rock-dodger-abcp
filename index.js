...
function checkCollision(rock) {
  ...
  if (top > 360) {
   ...
   // console.log(`top of rock: ${top}; dodgerLeftEdge: ${dodgerLeftEdge}; dodgerRightEdge: ${dodgerLeftEdge}, rockLeftEdge: ${rockLeftEdge}; rockRightEdge: ${rockRightEdge}`)
...
function moveDodgerLeft() {
  ...
  function stepLeft() {
    ...
    //positionpx = dodgerElement.style.left;
...
function moveDodgerRight() {
   var positionpx, positioninnum;

   function stepRight() {
     
     DODGER.style.left = `${positioninnum += 4}px`;
     positioninnum = positionToInteger(DODGER.style.left);

     if (positioninnum < 360) {
